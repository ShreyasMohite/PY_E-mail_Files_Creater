...
class File:
    def __init__(self,root):
        self.root=root
        self.root.title("E-mail File Extention")
        self.root.geometry("500x400")
        self.root.iconbitmap("logo900.ico")
...
#======================================================================================#
        ...
        def clear():
            ...
            filextention.set("Select E-mail File Extention")
                ...
                if path.get()!="":
                    ...
                    if filextention.get()!="Select E-mail File Extention":
                        if filename.get()!="":
                            ...
                            if filextention.get()=="Outlook Express e-mail message file" and filename.get()!="":
                                touch.touch(a+"/{}.email".format(filename.get()))
                            
                            if filextention.get()=="E-mail message file" and filename.get()!="":
                                touch.touch(a+"/{}.eml".format(filename.get()))
                        

                            if filextention.get()=="Apple Mail e-mail file" and filename.get()!="":
                                touch.touch(a+"/{}.emlx".format(filename.get()))
                            

                            if filextention.get()=="Microsoft Outlook e-mail message file" and filename.get()!="":
                                touch.touch(a+"/{}.msg".format(filename.get()))

                            if filextention.get()=="Microsoft Outlook e-mail template file" and filename.get()!="":
                                touch.touch(a+"/{}.oft".format(filename.get()))

                            if filextention.get()=="Microsoft Outlook offline e-mail storage file" and filename.get()!="":
                                touch.touch(a+"/{}.ost".format(filename.get()))
                            
                            if filextention.get()=="Microsoft Outlook e-mail storage file" and filename.get()!="":
                                touch.touch(a+"/{}.pst".format(filename.get()))

                            if filextention.get()=="E-mail contact file" and filename.get()!="":
                                touch.touch(a+"/{}.vcf".format(filename.get()))
...
#======================================================================================#
        ...
        fileselect=["Outlook Express e-mail message file","E-mail message file","Apple Mail e-mail file",\
                    "Microsoft Outlook e-mail message file","Microsoft Outlook e-mail template file",\
                    "Microsoft Outlook offline e-mail storage file","Microsoft Outlook e-mail storage file","E-mail contact file"]
        fileselect_combo=Combobox(firstframe,values=fileselect,font=('arial',12),width=25,state="readonly",textvariable=filextention)
        fileselect_combo.set("Select E-mail File Extention")
